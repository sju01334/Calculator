...
class MainActivity : AppCompatActivity() {
    ...
    private val expressionTextView: TextView by lazy {
        findViewById(R.id.expressiontTextView)
    }
    ...
    private fun operatorButtonClicked(operator: String) {
        ...
        val ssb = SpannableStringBuilder(expressionTextView.text.toString());
        ssb.setSpan(
        ...
        Thread(Runnable {
            db.historyDao().getAll().reversed().forEach {
                runOnUiThread {
                    ...
                    historyView.findViewById<TextView>(R.id.expressiontTextView).text = it.expression
